        ...
        for (var i = 0; i < fields.length; i++) {
            ...
            if (col) {
                ...
                if (col.checkbox) {
                    ...
                    if (opts.expandAllRow) {
                        cc.push('<span class="datagrid-row-expander datagrid-row-collapse" style="display:inline-block;width:16px;height:16px;margin:0;cursor:pointer;" />');
                    } else {
