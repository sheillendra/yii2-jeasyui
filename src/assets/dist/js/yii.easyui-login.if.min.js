...
content:""}}(window.jQuery);$.extend($.fn.validatebox.defaults.rules,{justText:{validator:function(b,c){return!b.match(/[0-9]/)},message:"Please enter a text."},captcha:{validator:function(b,c){},message:"Captcha"}});