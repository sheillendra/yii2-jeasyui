...
<table width="100%">
    <tbody>
        ...
        <tr>
            <td width="80px"><?php echo Html::activeLabel($model, 'email') ?></td>
            <td>:</td>
            <td><?php echo Html::activeTextInput($model, 'email') ?></td>
        </tr>
        <tr>
            <td><?php echo Html::activeLabel($model, 'password') ?></td>
            <td>:</td>
            <td><?php echo Html::activePasswordInput($model, 'password') ?></td>
        </tr>
        <tr>
            <td></td>
            <td></td>
